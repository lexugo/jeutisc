      ...
      <>
        ...
        <form action='#' className='search'>
          <div className='by query'>
            ...
            <input name='q' type='search' placeholder='I have a question about...' autoComplete='off'/>
          </div>
          ...
          <div className='by categories'>
            <div className='categories'>
              <div className='category'>
                ...
                <p className='description'>Le terme <i>Autochtone</i> désigne une diversité de nations et de peuples.</p>
              </div>
              <div className='category'>
                <h3 className='title'>Réalités Autochtones</h3>
                <p className='description'>Le terme <i>Autochtone</i> désigne une diversité de nations et de peuples.</p>
        ...
        <nav className='ressources'>
          <div className='ressource'>
            ...
            <h4 className='title'><a href='#'>Premières nations, Inuit et Métis</a></h4>
            <span className='source'>Mikana et Amnistie Internationale</span>
            <p className='description'>
              Le terme Autochtone désigne une diversité de nations et de peuples ancrés dans les territoires qu'ils occupent depuis des millénaires.
              Leur histoires se rejoingne...
            </p>
          </div>
          <div className='ressource'>
            <span className='media'>
            ...
            <h4 className='title'><a href='#'>Oser s'en parler</a></h4>
            <span className='source'>Charlotte Côté</span>
            <p className='description'>
              Balado pour allochtones sur la réalité des peuples autochtones vivant au soit-disant Canada.
            </p>
          </div>
          <div className='ressource'>
            <span className='media'>
            ...
            <h4 className='title'><a href='#'>Mikana</a></h4>
            <p className='description'>
              Site oeuvrant à la sensibilisation sur les enjeux autochtones.
            </p>
          </div>
          <div className='ressource'>
            <span className='media'>
            ...
            <div className='by categories'>
              ...
              <div className='categories'>
                <a href='#' className='category'>
                  <input type='radio' id='1' name='category' value='Réalités Autochtones'/>
                  <label htmlFor='1'>Réalités Autochtones</label>
                </a>
                <a href='#' className='category'>
                  <input type='radio' id='2' name='category' value='Environement'/>
                  <label htmlFor='2'>Environement</label>
                </a>
                <a href='#' className='category'>
                  <input type='radio' id='3' name='category' value='Immigration'/>
                  <label htmlFor='3'>Immigration</label>
                </a>
                <a href='#' className='category'>
                  <input type='radio' id='4' name='category' value='Environement'/>
                  <label htmlFor='4'>Environement</label>
                </a>
                <a href='#' className='category'>
                  <input type='radio' id='5' name='category' value='Racism'/>
                  <label htmlFor='5'>Racism</label>
                  <div className='subcategories'>
                    <a href='#' className='subcategory'>
                      <input type='radio' id='11' name='subcategory' value='Test'/>
                      <label htmlFor='11'>Test</label>
                    </a>
                    <a href='#' className='subcategory'>
                      <input type='radio' id='22' name='subcategory' value='Crise Climatique'/>
                      <label htmlFor='22'>Crise Climatique</label>
                    </a>
                    <a href='#' className='subcategory'>
                      <input type='radio' id='33' name='subcategory' value='Fin du monde'/>
                ...
                <a href='#' className='category'>
                  <input type='radio' id='6' name='category' value='Feminisme'/>
                  <label htmlFor='6'>Feminisme</label>
                </a>
                <a href='#' className='category'>
                  <input type='radio' id='7' name='category' value='Réalités Autochtones'/>
